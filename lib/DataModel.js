...
var DataModel = /** @class */ (function () {
    function DataModel(properties, dataProvider, isNewInstance) {
        ...
        this._clientId = "model_" + Date.now() + "_" + ++clientIdCounter;
        this.getClientId = function () { return _this._clientId; }; //this.getProperty<string>(CLIENT_ID_ATTRIBUTE)
