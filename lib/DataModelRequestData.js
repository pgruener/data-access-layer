...
exports.DataModelRequestData = void 0;
...
var DataModelRequestData = /** @class */ (function (_super) {
    ...
    function DataModelRequestData(dataProvider, dataModel, action) {
        ...
        _this.getActionUrl = function () {
            var actionUrl = _this._dataModel.dataProviderConfig.getActionUrlSet().computeActionUrl(_this.action, _this._dataModel);
            return actionUrl;
        };
        _this._dataModel = dataModel;
        _this._dataModel.informAboutDataModelRequestData(_this);
